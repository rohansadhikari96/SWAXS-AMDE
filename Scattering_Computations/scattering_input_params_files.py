...
params = {
    ...
    "q_max": 0.5,                   # Maximum value of q in Angstroms
    ...
    "solv_dens_corr": 0,            # Any value greater than 0 applies solvent density corrections to the scattering calculation
    "corr_solv_dens": 0.3337,       # Value for corrected bulk sollvent density in e/A^3
    "guinier_analysis": 1,          # Perform a Guinier analysis calculation to obtain Rg from scattering data
...
output_files = {
    "comp_iq": 'Explicit_Water_q_Iq_10_Frames.txt', # File position and name for computed I(q) from simulation trajectories
    "guinier_file": 'Guinier_Analysis_10_Frames.txt', # File position and name for computed Rg of simulated system
    "comp_iq_exp_fit": '' # Computed I(q) from simulations fit to experimental data as specified by user
}
